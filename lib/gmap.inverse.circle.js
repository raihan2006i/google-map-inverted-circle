...
function InverseCircle(opts) {
  ...
  // Bind the marker map property to the InverseCircle map property
  center_marker.bindTo('map', this);
  center_marker.bindTo('draggable', this);
  
  // Bind the marker position property to the InverseCircle position property
...
InverseCircle.prototype = new google.maps.MVCObject();

InverseCircle.prototype.position_changed = function()
{
...
InverseCircle.prototype.radius_changed = function()
{
  if(this.get('donut')){
    var paths = new this.Overlay;
    var spot = this.drawSpot_(this.getCenter(), this.getRadius() / 1000);
...
InverseCircle.prototype.visible_changed = function()
{
...
InverseCircle.prototype.setVisible = function(visible)
{
...
InverseCircle.prototype.getVisible = function()
{
  return this.get('visible');
};

InverseCircle.prototype.setCenter = function(center)
{
  this.set('position', center);
};

InverseCircle.prototype.getCenter = function()
{
  return this.get('position');
};

InverseCircle.prototype.getRadius = function()
{
  return this.get('radius');
};

InverseCircle.prototype.setRadius = function(radius)
{
  this.set('radius', radius);
};

InverseCircle.prototype.getOldRadius = function()
{
  return this.get('old_radius');
};

InverseCircle.prototype.setOldRadius = function(radius)
{
  this.set('old_radius', radius);
};


InverseCircle.prototype.getEditable = function()
{
  return this.get('editable');
};

InverseCircle.prototype.setEditable = function(editable)
{
  this.set('editable', editable);
};

InverseCircle.prototype.getDraggable = function()
{
  return this.get('draggable');
};

InverseCircle.prototype.setDraggable = function(draggable)
{
  this.set('draggable', draggable);
};

InverseCircle.prototype.getBounds = function()
{
...
/**
   ...
   * @private
   */
InverseCircle.prototype.addSizer_ = function() {
...
/**
   ...
   * @private
   */
InverseCircle.prototype.addVisibleController_ = function() {
...
/**
   ...
   * @private
   */
InverseCircle.prototype.extend_ = function(obj, extObj) {
...
/**
   ...
   * @private
   */
InverseCircle.prototype.drawSpot_ = function(point, radius) {
...
InverseCircle.prototype.Overlay = function () {
  var latExtent = 86;
  var lngExtent = 180;
...
/**
   ...
   * @private
   */
InverseCircle.prototype.drawCircle_ = function(map, center, radius){
